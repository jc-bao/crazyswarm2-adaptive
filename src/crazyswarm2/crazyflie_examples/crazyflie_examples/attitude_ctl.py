...
class Crazyflie:
    ...
    def __init__(self) -> None:
        ...
        # parameters
        self.world_center = np.array([0.0, 0.0, 1.3])
        self.mass = 0.028
        self.obj_mass = 0.00
        self.g = 9.81
    ...
    def pid_controller(self, info):
        ...
        for i in range(self.cf_num):
            ...
            force_target = - gravity_drone - (xyz_drone - xyz_target) * 0.2 - (vxyz_drone - vxyz_target) * 0.1
    ...
    def _generate_traj(self):
        ...
        As = np.array([[0.6, 0.0, 0.3], [0.8, 0.0, 0.4], [0.4, 0.4, 0.0]])
...
def main():
    ...
    # for cf in cfctl.allcfs.crazyflies:
    #     cf.emergency()
    ...
    print('landing...')
    target_point = np.array([cfctl.world_center]*cfctl.cf_num)
    target_point[:, 2] = 0.05
