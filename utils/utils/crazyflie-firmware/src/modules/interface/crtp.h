...
typedef enum {
  ...
  CRTP_PORT_SETPOINT         = 0x03, // rpy+thrust controller
  CRTP_PORT_MEM              = 0x04,
  CRTP_PORT_LOG              = 0x05,
  CRTP_PORT_LOCALIZATION     = 0x06,
  CRTP_PORT_SETPOINT_GENERIC = 0x07, // 7-6 full state; 7-0 stop; 7-5 hover; 7-7 position; 
  CRTP_PORT_SETPOINT_HL      = 0x08,
  CRTP_PORT_PLATFORM         = 0x0D,
  CRTP_PORT_LINK             = 0x0F,
  CRTP_PORT_ANGVEL           = 0x10,  // angular velocity controller
} CRTPPort;
